...
def getF():
    global capFrame
    print("video start")
    video_path = "rtsp://sourab:tvsm123!@192.168.0.200/stream1"
    # video_path = "rtsp://sourab:tvsm123!@10.42.0.44/stream1"
    # video_path ="rtsp://localhost:8554/mystream"
    # video_path = "C:/xampp/htdocs/gear_videos/nvideo/3.mp4"
    ...
    while True:
        ...
        if success:
            # print("suc")
            # cv2.imwrite("fullimg.png",frame)
            # frame = frame[472:1094,758:1911]
            # (h, w) = frame.shape[:2]
            # center = (w // 2, h // 2)
            # angle = 5  # -10
            # # Get rotation matrix
            ...
            frame = frame[:, 470:1600]  # y1:y2, x1:x2
            # now = datetime.now()
